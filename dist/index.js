...
var DatePicker = function (_a) {
    var _b = _a.label, label = _b === void 0 ? "Label" : _b, _c = _a.name, name = _c === void 0 ? "inputName" : _c, _d = _a.errorMessage, errorMessage = _d === void 0 ? "Erreur message" : _d, _e = _a.error, error = _e === void 0 ? false : _e, _f = _a.value, value = _f === void 0 ? "" : _f, _g = _a.lang, lang = _g === void 0 ? "fr-FR" : _g, year = _a.year, month = _a.month, day = _a.day, intervalYearsSelection = _a.intervalYearsSelection, _h = _a.elevationPicker, elevationPicker = _h === void 0 ? false : _h, _j = _a.headerPickerColor, headerPickerColor = _j === void 0 ? '#059ECE' : _j, _k = _a.borderColor, borderColor = _k === void 0 ? '#DADCE0' : _k, _l = _a.textColor, textColor = _l === void 0 ? '#70757A' : _l, _m = _a.focusColor, focusColor = _m === void 0 ? '#059ECE' : _m, _o = _a.errorColor, errorColor = _o === void 0 ? '#EF6C6C' : _o, _p = _a.borderRadius, borderRadius = _p === void 0 ? '5px' : _p, _q = _a.zIndex, zIndex = _q === void 0 ? 999 : _q, onSelect = _a.onSelect;
    var inputDate = react.useRef(null);
    var wrapperInputDate = react.useRef(null);
    var wrapperDate = react.useRef(null);
    var _r = react.useState(), showCalendar = _r[0], setShowCalendar = _r[1];
    var _s = react.useState(value), valueInput = _s[0], setValueInput = _s[1];
    var _t = react.useState(error), errorStatus = _t[0], setErrorStatus = _t[1];
    ...
    return (jsxRuntime.jsxs("div", index.__assign({ className: "date-picker" }, { children: [jsxRuntime.jsxs("div", index.__assign({ ref: wrapperInputDate, onClick: function () { return displayDatePicker(); }, className: "input-date".concat(valueInput !== "" ? " input-date--active" : "").concat(errorStatus ? " input-date--error" : "").concat(showCalendar ? " input-date--focus" : ""), style: {
                    zIndex: zIndex,
